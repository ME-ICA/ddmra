...
project = "ddmra"
copyright = "2021-" + datetime.today().strftime("%Y") + ", Taylor Salo"
author = "Taylor Salo"
...
version = ddmra.__version__
# The full version, including alpha/beta/rc tags.
release = ddmra.__version__
...
htmlhelp_basename = "ddmradoc"

# The following is used by sphinx.ext.linkcode to provide links to github
linkcode_resolve = make_linkcode_resolve(
    "ddmra", "https://github.com/me-ica/" "ddmra/blob/{revision}/" "{package}/{path}#L{lineno}"
)
