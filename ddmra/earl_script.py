...
def main(file_list, qc_list, out_dir=".", n_iters=10000, qc_thresh=0.2, earl=False, regress=False):
    """
...
if __name__ == "__main__":
    ...
    for earl in [True, False]:
        for regress in [True, False]:
            main(files, motpars, n_iters=n_iters, qc_thresh=fd_thresh, earl=earl, regress=regress)
